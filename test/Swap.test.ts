...
describe("HamsterSwap", async function () {
  ...
  it("Should: admin can configure pocket registry", async function () {
  ...
  it("should: anyone can fulfill proposal if he/she owns the required items and exec the pocket", async () => {
